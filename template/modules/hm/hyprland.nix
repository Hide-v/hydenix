...

{
  hydenix.hm.hyprland = {
    ...
    hypridle = {
      ...
      ''; # complete hypridle configuration override (null or lib.types.lines)
    };
    keybindings = {
      enable = true; # enable keybindings configurations
      extraConfig = ''
        bind = $mainMod Shift, F, layoutmsg, colresize +conf
        bind = $mainMod Shift Control, up, layoutmsg, togglefit
        bind = $mainMod SHIFT CONTROL, left, layoutmsg, "swapcol l"
        bind = $mainMod Shift Control, right, layoutmsg, "swapcol r"
      ...
      overrideConfig = ''
        ...
        bindd = Control, Return, $d application finder , exec, pkill -x rofi || $rofi-launch d
      ...
      ''; # complete keybindings configuration override (null or lib.types.lines)
    };
  };
}
