...
    ]) ++ lib.optionals (cfg.plugins != []) pluginPackages;
    ...
    home.file = {
      ...
      ".config/hypr/nvidia.conf" = lib.mkDefault { source = "${pkgs.hyde}/Configs/.config/hypr/nvidia.conf"; };
      ".config/hypr/userprefs.conf" = lib.mkDefault { source = "${pkgs.hyde}/Configs/.config/hypr/userprefs.conf"; };
      ".config/hypr/windowrules.conf" = lib.mkDefault { source = "${pkgs.hyde}/Configs/.config/hypr/windowrules.conf"; };
      ".config/hypr/animations.conf" = lib.mkDefault { source = "${pkgs.hyde}/Configs/.config/hypr/animations.conf"; };
      ".config/hypr/animations/classic.conf" = lib.mkDefault { source = "${pkgs.hyde}/Configs/.config/hypr/animations/classic.conf"; };
      ".config/hypr/animations/diablo-1.conf" = lib.mkDefault { source = "${pkgs.hyde}/Configs/.config/hypr/animations/diablo-1.conf"; };
      ".config/hypr/animations/diablo-2.conf" = lib.mkDefault { source = "${pkgs.hyde}/Configs/.config/hypr/animations/diablo-2.conf"; };
      ".config/hypr/animations/dynamic.conf" = lib.mkDefault { source = "${pkgs.hyde}/Configs/.config/hypr/animations/dynamic.conf"; };
      ".config/hypr/animations/disable.conf" = lib.mkDefault { source = "${pkgs.hyde}/Configs/.config/hypr/animations/disable.conf"; };
      ".config/hypr/animations/eevee-1.conf" = lib.mkDefault { source = "${pkgs.hyde}/Configs/.config/hypr/animations/eevee-1.conf"; };
      ".config/hypr/animations/eevee-2.conf" = lib.mkDefault { source = "${pkgs.hyde}/Configs/.config/hypr/animations/eevee-2.conf"; };
      ".config/hypr/animations/high.conf" = lib.mkDefault { source = "${pkgs.hyde}/Configs/.config/hypr/animations/high.conf"; };
      ".config/hypr/animations/low-1.conf" = lib.mkDefault { source = "${pkgs.hyde}/Configs/.config/hypr/animations/low-1.conf"; };
      ".config/hypr/animations/low-2.conf" = lib.mkDefault { source = "${pkgs.hyde}/Configs/.config/hypr/animations/low-2.conf"; };
      ".config/hypr/animations/minimal-1.conf" = lib.mkDefault { source = "${pkgs.hyde}/Configs/.config/hypr/animations/minimal-1.conf"; };
      ".config/hypr/animations/minimal-2.conf" = lib.mkDefault { source = "${pkgs.hyde}/Configs/.config/hypr/animations/minimal-2.conf"; };
      ".config/hypr/animations/moving.conf" = lib.mkDefault { source = "${pkgs.hyde}/Configs/.config/hypr/animations/moving.conf"; };
      ".config/hypr/animations/optimized.conf" = lib.mkDefault { source = "${pkgs.hyde}/Configs/.config/hypr/animations/optimized.conf"; };
